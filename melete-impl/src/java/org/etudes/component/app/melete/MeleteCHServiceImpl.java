/**********************************************************************************
 *
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.7.3/melete-impl/src/java/org/etudes/component/app/melete/MeleteCHServiceImpl.java $
 * $Id: MeleteCHServiceImpl.java 67059 2010-04-07 19:19:05Z rashmi@etudes.org $
 ***********************************************************************************
 *
        	...
        	if (!isUserAuthor())
   			...
   			//          setup a security advisor
        		...
        		if (resourceId != null)
        		{
        		  ...
        		  edit.setContentLength(contentEditor.getBytes().length);
        		  getContentservice().commitResource(edit);
        		  edit = null;
        		}
        		return;
